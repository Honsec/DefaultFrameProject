...
public class UtilsLog  {
    public static final String TAG = genius.utils.UtilsLog.class.getSimpleName();
    /**
     * 控制变量，是否显示log日志
     */
    ...
    public static void init(boolean isShowLog) {
        genius.utils.UtilsLog.isShowLog = isShowLog;
    }
    ...
    public static void init(boolean isShowLog, String defaultMsg) {
        genius.utils.UtilsLog.isShowLog = isShowLog;
        genius.utils.UtilsLog.defaultMsg = defaultMsg;
    }
